...
def process_pair(model_path, new_topo_path):
    ...
    try:
        v_tgt, vt_tgt, _, _, _, _ = obj_load_helper.load_uv_obj_file(model_path)
    ...
    try:
        v_src, vt_src, vn_src, _, _, _ = obj_load_helper.load_uv_obj_file(new_topo_path)
    except Exception as e:
