...
Saves a 5-panel grid to artifacts/debug/test_geo_output/.

Usage:
    python test_geo_feature_render.py --data_root G:/CapturedFrames_final8_processed
    python test_geo_feature_render.py --data_root G:/CapturedFrames_final8_processed \
        --sample_idx 3 --output_dir artifacts/debug/test_geo_output --model_dir assets/topology
"""
...
def load_geo_vertex_features(model_dir: str = "assets/topology", mesh_indices=None) -> np.ndarray:
    """
    For each mesh part:
...
def pack_geo_exrs_to_atlas_tex_pack(model_dir: str = "assets/topology", atlas_size: int = 2048) -> tuple[np.ndarray, np.ndarray]:
    """
...
def load_geo_texture_parts(model_dir: str = "assets/topology") -> list[dict]:
    """
...
def load_aux_and_model(model_dir: str = "assets/topology", device=None):
    from train_visualize_helper import load_combined_mesh_uv
    ...
    from scripts.visualize.visualize_geo_normal import load_combined_mesh_triangle_faces, remap_faces_after_filter
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", default="artifacts/debug/test_geo_output")
    parser.add_argument("--model_dir", default="assets/topology")
