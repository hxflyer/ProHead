...
Usage:
    ...
    python visualize_geo_normal.py --model_path artifacts/checkpoints/best_geometry_transformer_dim6.pth \
                                   --image_dir samples --output_dir vis_output --n 5
"""
...
def load_aux_data():
    ...
    template_mesh_uv = load_combined_mesh_uv(model_dir="assets/topology", copy=True).astype(np.float32)
    ...
    lm_idx_path = "assets/topology/landmark_indices.npy"
    ...
    lm2kp_idx = np.load("assets/topology/landmark2keypoint_knn_indices.npy")
    lm2kp_w   = np.load("assets/topology/landmark2keypoint_knn_weights.npy")
    n_keypoint = int(lm2kp_idx.max()) + 1
    mesh2lm_idx = np.load("assets/topology/mesh2landmark_knn_indices.npy")
    mesh2lm_w   = np.load("assets/topology/mesh2landmark_knn_weights.npy")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", default="artifacts/checkpoints/best_geometry_transformer_dim6.pth")
    parser.add_argument("--image_dir", default="samples")
    parser.add_argument("--output_dir", default="artifacts/vis_output")
