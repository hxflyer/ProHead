...
Output per image (mirrors GeometryDataset expected layout):
...
GeometryDataset._load_geometry divides by 1024, so for 1024×1024 images
...
# ──────────────────────────────────────────────────────────────────────────────
# Constants matching GeometryDataset training-time alignment
# ──────────────────────────────────────────────────────────────────────────────
...
def main():
    ...
    parser.add_argument("--model_path", type=str, default="artifacts/checkpoints/best_geometry_transformer_dim6.pth")
    parser.add_argument("--output_dir", type=str, default="artifacts/geometry_pseudo_gt")
    parser.add_argument("--model_dir",  type=str, default="assets/topology", help="Directory with template .npy files")
