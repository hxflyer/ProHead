...
from data_utils.camera_io import compute_vertex_depth, get_world_to_view_rotation, load_matrix_data, project_3d_to_2d_cpp_exact
from data_utils.obj_io import load_uv_obj_file


# ---------------------------------------------------------------------------
# Mesh face loading (from assets/topology/ OBJ files)
# ---------------------------------------------------------------------------
...
def _load_mesh_faces(model_dir: str = "assets/topology") -> dict[int, np.ndarray]:
