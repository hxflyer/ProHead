...
def compute_templates_paired(
    ...
    # Save templates
    np.save("assets/topology/landmark_template.npy", template_landmark)
    np.save("assets/topology/mesh_template.npy", template_mesh)
    
    print(f"\nSaved templates using {count} pairs (Aligned Normalization):")
    print(f"  - assets/topology/landmark_template.npy")
    print(f"  - assets/topology/mesh_template.npy")
