...
1. Loads the canonical geo atlas from model/geo_feature_atlas.npy.
...
from build_combined_knn import load_mesh_data_full
from metahuman_geometry_dataset import _load_exr_as_float32
...
def create_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--model_dir", type=str, default="model", help="Directory with template assets")
