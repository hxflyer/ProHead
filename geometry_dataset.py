"""
RGB+Geometry Dataset for Geometry Training (Landmark + Mesh)
...
class GeometryDataset(Dataset):
    """
    Dataset for RGB geometry training (landmark + mesh).
    ...
    def _load_default_templates(self) -> None:
        templates: GeometryTemplateSet = load_geometry_template_set(model_dir="assets/topology")
...
FastGeometryDataset = GeometryDataset
