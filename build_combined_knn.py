...
import numpy as np
import json
from obj_load_helper import load_simple_obj_file, load_uv_obj_file
...
def main():
    ...
    mask_tex_path = 'model/hair_mask_tex.png'
    ...
    # Save NPYs to model/
    np.save("model/mesh2landmark_knn_indices.npy", mesh2landmark_indices)
    np.save("model/mesh2landmark_knn_weights.npy", mesh2landmark_weights)
    np.save("model/landmark2keypoint_knn_indices.npy", landmark2keypoint_indices)
    np.save("model/landmark2keypoint_knn_weights.npy", landmark2keypoint_weights)
    
    # Save OBJs to visualization/
    ...
    # Save JSON to visualization/ with VERTICES
    ...
    # Generate Masks
    generate_mask_labels(unique_landmark_uvs, unique_landmark_is_head, mask_tex_path, "model/head_uv_points.png", "model/landmark_mask.txt")
    generate_mask_labels(unique_mesh_uvs, unique_mesh_is_head, mask_tex_path, "model/mesh_uv_points.png", "model/mesh_mask.txt")
